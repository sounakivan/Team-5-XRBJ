...
using UnityEngine;
using Normal.Internal.SimpleJson2;
...
namespace Normal {
    ...
    public class PackageManager {
        ...
        private static bool AddScopedRegistryIfNeeded() {
            ...
            // Deserialize
            SimpleJson2.TryDeserializeObject(packageManifestJSON, out object packageManifestObject);
            ...
            JsonArray2 scopedRegistries = scopedRegistriesObject as JsonArray2;
            if (scopedRegistries == null)
                packageManifest["scopedRegistries"] = scopedRegistries = new JsonArray2();
            ...
            normalRegistry["scopes"] = new JsonArray2 { "com.normalvr", "io.normcore" };
            scopedRegistries.Add(normalRegistry);

            // Serialize and save
            string packageManifestJSONUpdated = SimpleJson2.SerializeObject(packageManifest);
